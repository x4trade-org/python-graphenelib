...
class Testcases(unittest.TestCase):
    ...
    def test_B85hexgetb58(self):
        self.assertEqual(
            [
                "X4T2CAbTi1ZcgMJ5otBFZSGZJKJenwGa9NvkLxsrS49Kr8JsiSGc",
                "X4ThL45FEyUVSVV1LXABQnh4joS9FsUaffRtsdarB5uZjPsrwMZF",
                "X4T7DQR5GsfVaw4wJXzA3TogDhuQ8tUR2Ggj8pwyNCJXheHehL4Q",
                "X4Tqc4QMAJHAkna65i8U4b7nkbWk4VYSWpZebW7JBbD7MN8FB5sc",
                "X4T2QAVTJnJQvLUY4RDrtxzX9jS39gEq8gbqYMWjgMxvsvZTJxDSu",
            ],
            [
                format(
                    Base58(
    ...
    def test_Address(self):
        self.assertEqual(
            [
                format(
                    Address("X4TFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi", prefix="X4T"), "X4T"
                ),
                format(
                    Address("X4TdXrrTXimLb6TEt3nHnePwFmBT6Cck112", prefix="X4T"), "X4T"
                ),
                format(
                    Address("X4TJQUAt4gz4civ8gSs5srTK4r82F7HvpChk", prefix="X4T"), "X4T"
                ),
                format(
                    Address("X4TFPXXHXXGbyTBwdKoJaAPXRnhFNtTRS4EL", prefix="X4T"), "X4T"
                ),
                format(
                    Address("X4T3qXyZnjJneeAddgNDYNYXbF7ARZrRv5dr", prefix="X4T"), "X4T"
                ),
            ],
            [
                "X4TFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi",
                "X4TdXrrTXimLb6TEt3nHnePwFmBT6Cck112",
                "X4TJQUAt4gz4civ8gSs5srTK4r82F7HvpChk",
                "X4TFPXXHXXGbyTBwdKoJaAPXRnhFNtTRS4EL",
                "X4T3qXyZnjJneeAddgNDYNYXbF7ARZrRv5dr",
            ],
        )

        self.assertEqual(
            [
                bytes(Address("X4TFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi", prefix="X4T")),
                bytes(Address("X4TdXrrTXimLb6TEt3nHnePwFmBT6Cck112", prefix="X4T")),
                bytes(Address("X4TJQUAt4gz4civ8gSs5srTK4r82F7HvpChk", prefix="X4T")),
                bytes(Address("X4TFPXXHXXGbyTBwdKoJaAPXRnhFNtTRS4EL", prefix="X4T")),
                bytes(Address("X4T3qXyZnjJneeAddgNDYNYXbF7ARZrRv5dr", prefix="X4T")),
            ],
            [
            ...
            [
                bytes(
                    GrapheneAddress.from_pubkey(
                        PublicKey(
                            "X4T6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL",
                            prefix="X4T",
                        ),
                        prefix="X4T",
                    )
                ...
                bytes(
                    GrapheneAddress.from_pubkey(
                        PublicKey(
                            "X4T8YAMLtNcnqGNd3fx28NP3WoyuqNtzxXpwXTkZjbfe9scBmSyGT",
                            prefix="X4T",
                        ),
                        prefix="X4T",
                    )
                ...
                bytes(
                    GrapheneAddress.from_pubkey(
                        PublicKey(
                            "X4T7HUo6bm7Gfoi3RqAtzwZ83BFCwiCZ4tp37oZjtWxGEBJVzVVGw",
                            prefix="X4T",
                        ),
                        prefix="X4T",
                    )
                ...
                bytes(
                    GrapheneAddress.from_pubkey(
                        PublicKey(
                            "X4T6676cZ9qmqPnWMrm4McjCuHcnt6QW5d8oRJ4t8EDH8DdCjvh4V",
                            prefix="X4T",
                        ),
                        prefix="X4T",
                        compressed=True,
    ...
    def test_PubKey(self):
        self.assertEqual(
            [
                ...
                format(
                    PublicKey(
                        "X4T7u8m6zUNuzPNK1tPPLtnipxgqV9mVmTzrFNJ9GvovvSTCkVUra",
                        prefix="X4T",
                    ).address,
                    "X4T",
                ),
            ...
            [
                "X4T66FCjYKzMwLbE3a59YpmFqA9bwporT4L3",
                "X4TKNpRuPX8KhTBsJoFp1JXd7eQEsnCpRw3k",
                "X4T838ENJargbUrxXWuE2xD9HKjQaS17GdCd",
                "X4TNsrLFWTziSZASnNJjWafFtGBfSu8VG8KU",
                "X4TDjAGuXzk3WXabBEgKKc8NsuQM412boBdR",
            ],
        )
    ...
    def test_btsprivkey(self):
        self.assertEqual(
            ...
            [
                "X4TGu2U7Q3rmkCUCkQH2SToLMjEVUr86GrpA",
                "X4T9YgTfC8EfkgDG7DoRXJpMVKRougo64Lop",
                "X4TBXqRucGm7nRkk6jm7BNspTJTWRtNcx7k5",
                "X4T5tTDDR6M3mkcyVv16edsw8dGUyNQZrvKU",
                "X4T8G9ATJbJewVjTgTGmLGLNe1uP5XDWzaKX",
            ],
        )
    ...
    def test_uncompressed_privatekey(self):
        self.assertEqual(
            ...
            [
                "X4T677ZZd62Ca7SoUJoT1CytBhj4aJewzzi8tQZxYNqpSSK69FTuF",
                "X4T5z5e3BawwMY6UmcBQxYpkKZ8QQm4wdtS4KMZiWAcWBUC3RJuLT",
                "X4T7W5qsanXHgRAZPijbrLMDwX6VmHqUdL2s8PZiYKD5h1R7JaqRJ",
                "X4T86qPFWptPfUNKVi6hemeEWshoLerN6JvzCvFjqnRSEJg7nackU",
                "X4T57qhJwt9hZtBsGgV7J5ZPHFi5r5MEeommYnFpDb6grK3qev2qX",
            ],
        )
    ...
    def test_gphprivkeystr(self):
        self.assertEqual(
            ...
            [
                ...
                "X4T4XPkBqYw882fH5aR5S8mMKXCaZ1yVA76f",
            ],
        )

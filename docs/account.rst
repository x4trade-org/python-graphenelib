...
.. code-block:: python
    ...
    print("X4T PubKey (hex)        : " + repr(private_key.pubkey))
    print("X4T PubKey              : " + format(private_key.pubkey, "X4T"))
    print("X4T Address             : " + format(private_key.address,"X4T"))
...
Output::
    ...
    X4T PubKey (hex)        : 021760b78d93878af16f8c11d22f0784c54782a12a88bbd36be847ab0c8b2994de
    X4T PubKey              : X4T54nWRnewkASXXTwpn3q4q8noadzXmw4y1KpED3grup7VrDDRmx
    X4T Address             : X4TCmUwH8G1t3VSZRH5kwxx31tiYDNrzWvyW
